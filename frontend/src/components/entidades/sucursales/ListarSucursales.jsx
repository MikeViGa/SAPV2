...
import { eliminarSucursalApi, obtenerReporteSucursalApi } from "../../api/SucursalApiService";
...
export default function ListarSucursales({ refrescar, regs }) {
  ...
  const descargarReporte = async () => {
    ...
    try {
      const respuesta = await obtenerReporteSucursalApi();
