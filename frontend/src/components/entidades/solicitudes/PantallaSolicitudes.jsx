...
import { obtenerSolicitudNombreApi, obtenerSolicitudApi, obtenerSolicitudesApi } from '../../api/SolicitudApiService';
...
export default function PantallaSolicitudes() {
    ...
    const { 
        ...
        const obtenerOpciones = async (consulta) => {
            try {
                const respuesta = await obtenerSolicitudNombreApi(consulta);
        ...
        return (
            <ScreenWrapper loading={cargando}>
                ...
                <Item>
                    <ListarSolicitudes refrescar={mostrarRegistros} regs={registros} />
                </Item>
