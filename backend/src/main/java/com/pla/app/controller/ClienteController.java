...
public class ClienteController {
	...
	public ResponseEntity<List<String>> obtenerColoniasClientes(@RequestParam(name = "q", required = false) String q) {
		List<String> colonias = clienteServicio.obtenerColoniasClientes(q);
